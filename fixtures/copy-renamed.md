# Lock free idempotency for incoming webhooks

Payment providers retry a webhook until they see a success status, and they
retry quickly when a response is slow. A receiver that does real work on
...
that hold for every major provider I checked: each event carries a stable
...
Measured on a queue of fifty thousand replayed deliveries, the receiver produced
